#pragma once
// Konstanta WAJIB selaras dengan firmware Arduino (sama seperti backend/config.py).
...
constexpr int AUDIO_SAMPLERATE = 192000;
...
constexpr double FFT_MAX_FREQ_HZ = 20000.0;
