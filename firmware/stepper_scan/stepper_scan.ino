...
// Arduino 1 SoftSerial TX (pin 10) → Arduino 2 RX (pin 0), GND bersama
...
SoftwareSerial laserSerial(PIN_LASER_RX, PIN_LASER_TX);
...
void setup() {
  ...
  laserSerial.begin(LASER_LINK_BAUD);
...
void prosesPerintahSerial(String perintah) {
  // Izinkan f= dan stop meski sibuk? f= hanya saat idle agar SoftSerial stabil.
