...
def hitung_estimasi_durasi_s(
    ...
    """Estimasi total durasi raster scan (detik) -- 'waktu target'."""
...
def format_jam_menit(detik, bulatkan_ke_atas=False):
    """Format durasi (detik) menjadi teks 'X jam Y menit'."""
    if detik < 0:
        detik = 0
